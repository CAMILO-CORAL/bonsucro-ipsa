...
def metric_card(label, value, unit="", accent="#72B328", delta=None):
    ...
    if delta is not None:
        ...
        delta_html = f'<div style="font-family:\'Montserrat\',sans-serif;font-size:0.72rem;font-weight:500;color:{color};margin-top:4px;">{arrow} {abs(delta):.1f}%</div>'
    return f"""
    <div style="
    ...
    ">
      ...
      "></div>
      <div style="font-family:'Montserrat',sans-serif;font-size:0.65rem;letter-spacing:0.12em;
                  text-transform:uppercase;font-weight:600;color:#516E62;margin-bottom:10px;">{label}</div>
      <div style="font-family:'Montserrat',sans-serif;font-size:1.9rem;font-weight:700;
                  color:#08321F;line-height:1;">{value}
        <span style="font-size:0.9rem;font-weight:500;color:{accent};margin-left:4px;">{unit}</span>
      </div>
      {delta_html}
    </div>
    """
...
def section_header(title, subtitle="", icon=""):
    ...
    <div style="margin: 38px 0 18px; display:flex; align-items:flex-end; gap:14px;">
      <div>
        <div style="font-family:'Montserrat',sans-serif;font-size:0.62rem;letter-spacing:0.16em;
                    text-transform:uppercase;font-weight:600;color:#72B328;margin-bottom:4px;">{icon} {subtitle}</div>
...
def tag(text, color="#72B328"):
    return f'<span style="background:{color}18;color:{color};border:1px solid {color}40;border-radius:4px;padding:2px 8px;font-family:\'Montserrat\',sans-serif;font-size:0.68rem;font-weight:500;letter-spacing:0.03em;">{text}</span>'
...
">
  ...
  <div>
    <div style="font-family:'Montserrat',sans-serif;font-size:0.65rem;letter-spacing:0.18em;
                text-transform:uppercase;font-weight:600;color:#72B328;margin-bottom:4px;">
        Sistema de Monitoreo · Bonsucro
    </div>
    <div style="font-family:'Montserrat',sans-serif;font-size:1.7rem;font-weight:800;color:#004024;line-height:1.1;">
        Análisis de Áreas Afectadas en Haciendas
    </div>
    <div style="font-family:'Montserrat',sans-serif;font-size:0.82rem;font-weight:400;color:#516E62;margin-top:6px;">
...
with st.sidebar:
    ...
    <div style="padding: 16px 0 8px;">
        <div style="font-family:'Montserrat',sans-serif;font-size:0.6rem;letter-spacing:0.18em;
                    text-transform:uppercase;font-weight:600;color:#9AC864;margin-bottom:2px;"></div>
        <div style="font-family:'Montserrat',sans-serif;font-size:1.1rem;font-weight:700;color:#FFFFFF;">
            Panel de Control
        </div>
    </div>
    ...
    <div style="background:rgba(255,255,255,0.08);border:1px solid #5F8A6E;border-radius:8px;
        ...
        <div style="font-family:'Montserrat',sans-serif;font-size:0.65rem;font-weight:600;color:#D8EBCB;
                    letter-spacing:0.08em;text-transform:uppercase;">Umbral activo</div>
        <div style="font-family:'Montserrat',sans-serif;font-size:1.4rem;font-weight:700;
    ...
    st.markdown("<hr style='border-color:#5F8A6E;margin:20px 0;'>", unsafe_allow_html=True)
    st.markdown(f"""
    <div style="font-family:'Montserrat',sans-serif;font-size:0.65rem;font-weight:500;color:#D8EBCB;line-height:1.8;">
        <div>REGISTROS TOTALES &nbsp;<span style="color:#FFFFFF;font-weight:600;">{len(data):,}</span></div>
        <div>TENENCIAS &nbsp;<span style="color:#FFFFFF;font-weight:600;">{data['Tenencia'].nunique()}</span></div>
        <div>HACIENDAS &nbsp;<span style="color:#FFFFFF;font-weight:600;">{data['Nombre'].nunique()}</span></div>
    </div>
    """, unsafe_allow_html=True)
...
if filtered_data.empty:
    ...
    <div style="text-align:center;padding:70px 40px;border:1px dashed #9AC864;
        ...
        <div style="font-family:'Montserrat',sans-serif;font-size:1.1rem;font-weight:600;
                    color:#004024;margin-bottom:6px;">Sin datos seleccionados</div>
        <div style="font-family:'Montserrat',sans-serif;font-size:0.75rem;font-weight:400;color:#516E62;">
...
with col_a:
    ...
    <div style="background:linear-gradient(135deg,#FFFFFF,#EEF5E8);
        ...
        <div style="font-family:'Montserrat',sans-serif;font-size:0.62rem;letter-spacing:0.14em;
                    text-transform:uppercase;font-weight:700;color:#004024;margin-bottom:14px;">
            ● REGISTROS EN ALERTA
        </div>
        <div style="display:flex;gap:24px;flex-wrap:wrap;">
            <div>
                <div style="font-family:'Montserrat',sans-serif;font-size:2rem;font-weight:800;color:#004024;">
                    {n_criticas}
                </div>
                <div style="font-family:'Montserrat',sans-serif;font-size:0.68rem;font-weight:400;color:#516E62;">
                    Número de haciendas con afectación mayor al umbral definido
                </div>
            </div>
            <div>
                <div style="font-family:'Montserrat',sans-serif;font-size:2rem;font-weight:800;color:#72B328;">
                    {ha_criticas_sum:,.1f}
                </div>
                <div style="font-family:'Montserrat',sans-serif;font-size:0.68rem;font-weight:400;color:#516E62;">
        ...
        <div style="margin-top:16px;background:#D8EBCB;border-radius:6px;padding:8px 12px;">
            <div style="font-family:'Montserrat',sans-serif;font-size:0.7rem;font-weight:500;color:#08321F;">
...
with col_b:
    if not haciendas_criticas.empty:
        ...
        ax.set_xlabel('Afectación (%)', color='#516E62', fontsize=8, fontfamily='Montserrat')
        ax.tick_params(colors='#516E62', labelsize=7.5)
        ax.xaxis.label.set_fontfamily('Montserrat')
...
for rank, row in ranking_tenencias.iterrows():
    ...
    <tr style="border-bottom:1px solid #D8EBCB;">
      <td style="padding:10px 8px;font-family:'Montserrat',sans-serif;font-size:0.72rem;
                 font-weight:500;color:#516E62;text-align:center;">{rank:02d}</td>
      <td style="padding:10px 12px;font-family:'Montserrat',sans-serif;font-size:0.82rem;
                 font-weight:500;color:#08321F;">{tenencia_txt}</td>
      <td style="padding:10px 8px;text-align:right;font-family:'Montserrat',sans-serif;
                 font-size:0.78rem;color:{bar_color};font-weight:600;">
          {pct:.2f}%
      </td>
      ...
      <td style="padding:10px 8px;font-family:'Montserrat',sans-serif;font-size:0.72rem;
                 font-weight:500;color:#516E62;text-align:right;">{hectareas:,.1f} Ha</td>
      <td style="padding:10px 8px;font-family:'Montserrat',sans-serif;font-size:0.72rem;
                 font-weight:500;color:#516E62;text-align:right;">{haciendas} haciendas</td>
    </tr>
    """
  ...
  <table style="width:100%;border-collapse:collapse;background:#FFFFFF;">
    <thead>
      <tr style="background:#D8EBCB;border-bottom:2px solid #9AC864;">
        <th style="padding:10px 8px;font-family:'Montserrat',sans-serif;font-size:0.62rem;
                   letter-spacing:0.12em;text-transform:uppercase;font-weight:700;color:#004024;text-align:center;">#</th>
        <th style="padding:10px 12px;font-family:'Montserrat',sans-serif;font-size:0.62rem;
                   letter-spacing:0.12em;text-transform:uppercase;font-weight:700;color:#004024;text-align:left;">Tenencia</th>
        <th style="padding:10px 8px;font-family:'Montserrat',sans-serif;font-size:0.62rem;
                   letter-spacing:0.12em;text-transform:uppercase;font-weight:700;color:#004024;text-align:right;">Afectación</th>
        <th style="padding:10px 16px;font-family:'Montserrat',sans-serif;font-size:0.62rem;
                   letter-spacing:0.12em;text-transform:uppercase;font-weight:700;color:#004024;text-align:left;">Promedio</th>
        <th style="padding:10px 8px;font-family:'Montserrat',sans-serif;font-size:0.62rem;
                   letter-spacing:0.12em;text-transform:uppercase;font-weight:700;color:#004024;text-align:right;">Hectáreas</th>
        <th style="padding:10px 8px;font-family:'Montserrat',sans-serif;font-size:0.62rem;
                   letter-spacing:0.12em;text-transform:uppercase;font-weight:700;color:#004024;text-align:right;">Haciendas</th>
      </tr>
    </thead>
    <tbody>
      {rows_html}
...
if not hacienda_data.empty:
    ...
    <div style="background:linear-gradient(135deg,#FFFFFF,#EEF5E8);
        ...
        <div>
            <div style="font-family:'Montserrat',sans-serif;font-size:0.6rem;letter-spacing:0.12em;
                        text-transform:uppercase;font-weight:600;color:#516E62;">Hacienda</div>
            <div style="font-family:'Montserrat',sans-serif;font-size:1.1rem;font-weight:700;
                        color:#004024;">{hacienda_filtrada}</div>
        </div>
        <div>
            <div style="font-family:'Montserrat',sans-serif;font-size:0.6rem;letter-spacing:0.12em;
                        text-transform:uppercase;font-weight:600;color:#516E62;">Código</div>
            <div style="font-family:'Montserrat',sans-serif;font-size:0.95rem;font-weight:500;color:#08321F;">
                {codigo_hacienda}
            </div>
        </div>
        <div>
            <div style="font-family:'Montserrat',sans-serif;font-size:0.6rem;letter-spacing:0.12em;
                        text-transform:uppercase;font-weight:600;color:#516E62;">Tenencia</div>
            <div style="font-family:'Montserrat',sans-serif;font-size:0.85rem;font-weight:500;color:#72B328;">
                {tenencia_hacienda}
            </div>
        </div>
        <div>
            <div style="font-family:'Montserrat',sans-serif;font-size:0.6rem;letter-spacing:0.12em;
                        text-transform:uppercase;font-weight:600;color:#516E62;">Área caña</div>
            <div style="font-family:'Montserrat',sans-serif;font-size:0.95rem;font-weight:600;
                        color:#08321F;">{row0.get('Area caña (Ha)', 0):,.1f} Ha</div>
        </div>
        <div>
            <div style="font-family:'Montserrat',sans-serif;font-size:0.6rem;letter-spacing:0.12em;
                        text-transform:uppercase;font-weight:600;color:#516E62;">Afectación total</div>
            <div style="font-family:'Montserrat',sans-serif;font-size:1.3rem;font-weight:800;
...
<div style="margin-top:48px;border-top:1px solid #9AC864;padding:16px 0;
    ...
    <div style="font-family:'Montserrat',sans-serif;font-size:0.62rem;font-weight:600;color:#516E62;letter-spacing:0.06em;">
        🌿 BONSUCRO · SISTEMA DE MONITOREO DE ÁREAS AFECTADAS
    </div>
    <div style="font-family:'Montserrat',sans-serif;font-size:0.62rem;font-weight:500;color:#5F8A6E;">
